...
public class NewLrcView extends View implements ILrcView{
    /**所有的歌词***/
    ...
    /**高亮歌词的默认字体大小***/
    public static final float DEFAULT_SIZE_FOR_HIGH_LIGHT_LRC = 40;
    /**歌词间默认的行距**/
//	private static final float DEFAULT_PADDING = 50;
    ...
    public NewLrcView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
...
//        mSizeForOtherLrc = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,13, APlayerApplication.getContext().getResources().getDisplayMetrics());
        mSizeForOtherLrc = DEFAULT_SIZE_FOR_HIGH_LIGHT_LRC;
...
//        mSizeForTimeLine = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,13, APlayerApplication.getContext().getResources().getDisplayMetrics());
        mSizeForTimeLine = DEFAULT_SIZE_FOR_HIGH_LIGHT_LRC;
...
//					}
    ...
    private LrcView.OnSeekToListener onSeekToListener;
    public void setOnSeekToListener(LrcView.OnSeekToListener onSeekToListener) {
    ...
    private LrcView.OnLrcClickListener mOnLrcClickListener;
    public void setOnLrcClickListener(LrcView.OnLrcClickListener mOnLrcClickListener) {
