...
class SmbDataSource : BaseDataSource(true) {
  ...
  override fun open(dataSpec: DataSpec): Long {
    ...
    try {
      ...
      // Use encodedUserInfo to correctly parse parts containing special characters (e.g. colon in password)
      ...
      if (!userInfo.isNullOrEmpty()) {
        ...
        if (colonIndex != -1) {
          userPartRaw = userInfo.substring(0, colonIndex)
      ...
      Timber.tag(TAG).v("Try connect to host: ${uri.host} port: ${uri.port}")
      ...
      Timber.tag(TAG).v("SMB Connected")
      ...
      Timber.tag(TAG).e(e, "SMB Open Failed")
      cleanup()
  ...
  override fun read(buffer: ByteArray, offset: Int, readLength: Int): Int {
    ...
    try {
      ...
      Timber.tag(TAG).e(e, "SMB Read Failed")
      throw IOException(e)
    }
  }
