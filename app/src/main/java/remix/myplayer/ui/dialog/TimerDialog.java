...
public class TimerDialog extends BaseDialog {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        //读取保存的配置
        boolean hasDefault = SPUtil.getValue(mContext, SPUtil.SETTING_KEY.NAME, SPUtil.SETTING_KEY.TIMER_DEFAULT, false);
        ...
        mSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
                if (mSaveTime > 0) {
                    ...
                    SPUtil.putValue(mContext, SPUtil.SETTING_KEY.NAME, SPUtil.SETTING_KEY.TIMER_DEFAULT, true);
                    SPUtil.putValue(mContext, SPUtil.SETTING_KEY.NAME, SPUtil.SETTING_KEY.TIMER_DURATION, mSaveTime);
                } else {
