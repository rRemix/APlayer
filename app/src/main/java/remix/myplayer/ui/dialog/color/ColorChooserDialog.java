...
public class ColorChooserDialog extends DialogFragment implements View.OnClickListener,
  ...
  private class ColorGridAdapter extends BaseAdapter {
    ...
    public int getCount() {
      if (isInSub()) {
        return mColorsSub[topIndex()].length;
      } else {
        return mColorsTop.length;
      }
    }
    ...
    public Object getItem(int position) {
      if (isInSub()) {
        return mColorsSub[topIndex()][position];
      } else {
        return mColorsTop[position];
      }
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      @ColorInt final int color =
          isInSub() ? mColorsSub[topIndex()][position] : mColorsTop[position];
  ...
  @Nullable
  public static ColorChooserDialog findVisible(@NonNull AppCompatActivity context,
      @ColorChooserTag String tag) {
    Fragment frag = context.getSupportFragmentManager().findFragmentByTag(tag);
