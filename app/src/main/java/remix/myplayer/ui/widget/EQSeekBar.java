...
public class EQSeekBar extends View {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mEnableTrackColor = typedArray.getColor(R.styleable.EQSeekBar_eqenabletrackcolor,
                ColorUtil.getColor(ThemeStore.isLightTheme() ? R.color.light_enable_track_color : R.color.dark_enable_track_color));
...
//                ColorUtil.getColor(ThemeStore.isLightTheme()() ? ThemeStore.getMaterialPrimaryColorRes() : R.color.night_nonenable_progress_color));
        mEnableTextColor = typedArray.getColor(R.styleable.EQSeekBar_eqtextcolor,
                ColorUtil.getColor(ThemeStore.isLightTheme() ? R.color.light_enable_text_color : R.color.dark_enable_text_color));

        //非使能状态下的颜色
        mTrackColor = typedArray.getColor(R.styleable.EQSeekBar_eqtrackcolor,
                ColorUtil.getColor(ThemeStore.isLightTheme() ? R.color.light_nonenable_track_color : R.color.dark_nonenable_track_color));
        mProgressColor = typedArray.getColor(R.styleable.EQSeekBar_eqprogresscolor,
                ColorUtil.getColor(ThemeStore.isLightTheme() ? R.color.light_nonenable_progress_color : R.color.dark_nonenable_progress_color));
        mTextColor = typedArray.getColor(R.styleable.EQSeekBar_eqtextcolor,
                ColorUtil.getColor(ThemeStore.isLightTheme() ? R.color.light_nonenable_text_color : R.color.dark_nonenable_text_color));
