      ...
      public void run() {
        try {
          ...
          for (short i = 0; i < mBandNumber; i++) {
            short temp = (short) (SPUtil
                .getValue(App.getContext(), SPUtil.SETTING_KEY.NAME, "Band" + i, 0));
...
//        }
  ...
  private void addEQSeekBar() {
    LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(DensityUtil.dip2px(this, 30),
    ...
    mEQContainer.getViewTreeObserver()
