...
package remix.myplayer.ui.customview.fastscroll.recyclerview_fastscroll.views;
...
import remix.myplayer.ui.customview.fastscroll.recyclerview_fastscroll.interfaces.OnFastScrollStateChangeListener;
import remix.myplayer.ui.customview.fastscroll.recyclerview_fastscroll.utils.Utils;
...
public class FastScroller {
    ...
    public FastScroller(Context context, FastScrollRecyclerView recyclerView, AttributeSet attrs) {
        ...
        try {
            ...
            CommonUtil.uploadException("FastScroll","FastScroller Init Error:" + e.toString());
        }  finally{
            typedArray.recycle();
        }
