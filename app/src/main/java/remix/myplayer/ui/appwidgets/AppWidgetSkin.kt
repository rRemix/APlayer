...
enum class AppWidgetSkin(
  ...
  @param:DrawableRes val loveRes: Int, @param:DrawableRes val playRes: Int,
  @param:DrawableRes val pauseRes: Int
) {
  ...
  TRANSPARENT(
    ...
    R.drawable.widget_btn_play_normal_transparent, R.drawable.widget_btn_stop_normal_transparent
  );
