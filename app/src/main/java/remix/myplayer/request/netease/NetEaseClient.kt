...
import remix.myplayer.compose.lyric.decrypt.NetEaseEapiCrypt.eapiParamsEncrypt
import remix.myplayer.compose.lyric.decrypt.NetEaseEapiCrypt.eapiResponseDecrypt
...
interface NetEaseClientEntryPoint {

  fun netEaseClient(): NetEaseClient
}
