...
public class LibraryUriRequest extends ImageUriRequest<String> {
  ...
  public LibraryUriRequest(@NonNull SimpleDraweeView image, @NonNull UriRequest request,
...
//        mImage.setImageURI(Uri.EMPTY);
  ...
  public void onSuccess(String result) {
    ...
    if (mConfig.isResize()) {
      imageRequestBuilder
          .setResizeOptions(ResizeOptions.forDimensions(mConfig.getWidth(), mConfig.getHeight()));
    }
    DraweeController controller = Fresco.newDraweeControllerBuilder()
        ...
        .setControllerListener(new ControllerListener<ImageInfo>() {
          ...
          @Override
          public void onFinalImageSet(String s, @Nullable ImageInfo imageInfo,
