...
public final class TintHelper {
  ...
  public static void setTintSelector(@NonNull View view, @ColorInt final int color,
    ...
    if (view instanceof Button) {
      ...
      button.setTextColor(getDisabledColorStateList(textColor, ContextCompat
          .getColor(view.getContext(), useDarkTheme ? R.color.ate_button_text_disabled_dark
  ...
  public static void setTintAuto(final @NonNull View view, final @ColorInt int color,
    ...
    if (!background) {
      ...
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP &&
        ...
        RippleDrawable rd = (RippleDrawable) view.getBackground();
        @SuppressLint("PrivateResource") final int unchecked = ContextCompat
            .getColor(view.getContext(),
  ...
  private static Drawable modifySwitchDrawable(@NonNull Context context, @NonNull Drawable from,
      @ColorInt int tint, boolean thumb, boolean compatSwitch, boolean useDarker) {
    if (useDarker) {
    ...
    int normal;
    if (thumb) {
      disabled = ContextCompat.getColor(context, useDarker ? R.color.ate_switch_thumb_disabled_dark
      ...
      disabled = ContextCompat.getColor(context, useDarker ? R.color.ate_switch_track_disabled_dark
