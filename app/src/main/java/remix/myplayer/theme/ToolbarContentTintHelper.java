...
public final class ToolbarContentTintHelper {
  ...
  public static void handleOnPrepareOptionsMenu(Activity activity, Toolbar toolbar) {
    handleOnPrepareOptionsMenu(activity, toolbar, ThemeStore.getAccentColor());
  }
              ...
              .addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                  try {
                    ...
                    final boolean isDark = !ColorUtil.isColorCloseToWhite(
                        Theme.resolveColor(context, android.R.attr.windowBackground));
    ...
    public static final class SearchViewTintUtil {
      ...
      private static void tintImageView(Object target, Field field, final @ColorInt int color)
        ...
        if (imageView.getDrawable() != null) {
          imageView
              .setImageDrawable(TintHelper.createTintedDrawable(imageView.getDrawable(), color));
        }
      }
